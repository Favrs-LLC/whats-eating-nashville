  ...
  useEffect(() => {
    const loadInstagramEmbed = async () => {
      try {
        ...
        if (!window.instgrm) {
          // Create and load the Instagram embed script
        ...
        <div className="flex flex-col items-center text-center space-y-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600 mb-4">
              View this post on Instagram to see the full content and media.
            </p>
